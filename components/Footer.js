          ...
          <Row>
            <Col>
              <img
                ...
                style={{ height: "10vh" }}
              />
              <p className={footerStyle.footerAddress}>
                You may find us <br /> Registered in Ethiopia No: xxxxx
                <br /> Registered office: Some building xth floor, <br /> Bole,
                Addis Ababa
              </p>
            </Col>
            <Col>
              <h4 className={footerStyle.footerHeader}>Resources</h4>
              <ul className={footerStyle.reference}>
                <li>
                  <a className={footerStyle.footerLink} href="www.era.gov.et">
            ...
            <Col>
              <h4 className={footerStyle.footerHeader}>
                Our vision and mission
              </h4>
              <p className={footerStyle.footerVision}>
                **
                <br /> this place will be used for a summerized
                <br /> vision and mission of BD lithops
                <br />
                **
              </p>
            </Col>
      ...
      <footer className={footerStyle.footer}>
        ...
        <section className={footerStyle.ftLegal}>
          <ul className={cx(footerStyle.ftLegalList)}>
            ...
            <li className={cx(footerStyle.ftLegalList)}>
              &copy; 2021 Copyright BD Lithops Construction.
            </li>
          </ul>
        </section>
      </footer>
